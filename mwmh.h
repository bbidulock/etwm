...
enum MWM_FUNC {
    ...
    MWM_FUNC_SHADE_BIT,		/* like _NET_WM_ACTION_SHADE */
    MWM_FUNC_STICK_BIT,		/* like _NET_WM_ACTION_STICK */
    MWM_FUNC_FULLSCREEN_BIT,	/* like _NET_WM_ACTION_FULLSCREEN */
    MWM_FUNC_ABOVE_BIT,		/* like _NET_WM_ACTION_ABOVE */
    MWM_FUNC_BELOW_BIT,		/* like _NET_WM_ACTION_BELOW */
    MWM_FUNC_MAXIMUS_BIT	/* like _NET_WM_ACTION_MAXIMUS_(LEFT|RIGHT|TOP|BOTTOM) */
};
...
#define MWM_FUNC_SHADE		(1L << MWM_FUNC_SHADE_BIT)
#define MWM_FUNC_STICK		(1L << MWM_FUNC_STICK_BIT)
#define MWM_FUNC_FULLSCREEN	(1L << MWM_FUNC_FULLSCREEN_BIT)
#define MWM_FUNC_ABOVE		(1L << MWM_FUNC_ABOVE_BIT)
#define MWM_FUNC_BELOW		(1L << MWM_FUNC_BELOW_BIT)
#define MWM_FUNC_MAXIMUS	(1L << MWM_FUNC_MAXIMUS_BIT)
...
enum MWM_DECOR {
    ...
    MWM_DECOR_CLOSE_BIT,	/* non-standard close button */
    MWM_DECOR_RESIZE_BIT,	/* non-standard resize button */
    MWM_DECOR_SHADE_BIT,	/* non-standard shade button */
    MWM_DECOR_STICK_BIT,	/* non-standard stick button */
    MWM_DECOR_MAXIMUS_BIT	/* non-standard maximus buttons */
};
...
#define MWM_DECOR_CLOSE		(1L << MWM_DECOR_CLOSE_BIT)
#define MWM_DECOR_RESIZE	(1L << MWM_DECOR_RESIZE_BIT)
#define MWM_DECOR_SHADE		(1L << MWM_DECOR_SHADE_BIT)
#define MWM_DECOR_STICK		(1L << MWM_DECOR_STICK_BIT)
#define MWM_DECOR_MAXIMUS	(1L << MWM_DECOR_MAXIMUS_BIT)
