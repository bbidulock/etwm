...
enum _WIN_STATE {
    WIN_STATE_STICKY_BIT = 0,		/* everyone knows sticky */
    WIN_STATE_MINIMIZED_BIT,		/* Reserved - definition is unclear */
    WIN_STATE_MAXIMIZED_VERT_BIT,	/* window in maximized V state */
    WIN_STATE_MAXIMIZED_HORIZ_BIT,	/* window in maximized H state */
    WIN_STATE_HIDDEN_BIT,		/* not on taskbar but window visible */
    WIN_STATE_SHADED_BIT,		/* shaded (MacOS / Afterstep style) */
    WIN_STATE_HID_WORKSPACE_BIT,	/* not on current desktop */
    WIN_STATE_HID_TRANSIENT_BIT,	/* owner of transient is hidden */
    WIN_STATE_FIXED_POSITION_BIT,	/* window is fixed in position even */
    WIN_STATE_ARRANGE_IGNORE_BIT	/* ignore for auto arranging */
};

#define WIN_STATE_STICKY		(1L<<WIN_STATE_STICKY_BIT)
#define WIN_STATE_MINIMIZED		(1L<<WIN_STATE_MINIMIZED_BIT)
#define WIN_STATE_MAXIMIZED_VERT	(1L<<WIN_STATE_MAXIMIZED_VERT_BIT)
#define WIN_STATE_MAXIMIZED_HORIZ	(1L<<WIN_STATE_MAXIMIZED_HORIZ_BIT)
#define WIN_STATE_HIDDEN		(1L<<WIN_STATE_HIDDEN_BIT)
#define WIN_STATE_SHADED		(1L<<WIN_STATE_SHADED_BIT)
#define WIN_STATE_HID_WORKSPACE		(1L<<WIN_STATE_HID_WORKSPACE_BIT)
#define WIN_STATE_HID_TRANSIENT		(1L<<WIN_STATE_HID_TRANSIENT_BIT)
#define WIN_STATE_FIXED_POSITION	(1L<<WIN_STATE_FIXED_POSITION_BIT)
#define WIN_STATE_ARRANGE_IGNORE	(1L<<WIN_STATE_ARRANGE_IGNORE_BIT)

/* values for _WIN_HINTS */
enum _WIN_HINTS {
    WIN_HINTS_SKIP_FOCUS_BIT = 0,
    WIN_HINTS_SKIP_WINLIST_BIT,
    WIN_HINTS_SKIP_TASKBAR_BIT,
    WIN_HINTS_GROUP_TRANSIENT_BIT,
    WIN_HINTS_FOCUS_ON_CLICK_BIT,
    WIN_HINTS_DO_NOT_COVER_BIT
};

#define WIN_HINTS_SKIP_FOCUS		(1L<<WIN_HINTS_SKIP_FOCUS_BIT)
#define WIN_HINTS_SKIP_WINLIST		(1L<<WIN_HINTS_SKIP_WINLIST_BIT)
#define WIN_HINTS_SKIP_TASKBAR		(1L<<WIN_HINTS_SKIP_TASKBAR_BIT)
#define WIN_HINTS_GROUP_TRANSIENT	(1L<<WIN_HINTS_GROUP_TRANSIENT_BIT)
#define WIN_HINTS_FOCUS_ON_CLICK	(1L<<WIN_HINTS_FOCUS_ON_CLICK_BIT)
#define WIN_HINTS_DO_NOT_COVER		(1L<<WIN_HINTS_DO_NOT_COVER_BIT)
